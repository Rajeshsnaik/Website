...
// Define the data for the team members (remains the same)
const teamMembers = [
  {
...
// Framer Motion animation variants (remains the same)
...
const LeadershipTeam = () => {
  return (
    <section className="py-16 sm:py-24 bg-gray-50 overflow-hidden">
      ...
      {/* 1. Top Section - Title and Description (Remains the same) */}
      ...
      >
        <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-3 lg:gap-8">
          {teamMembers.map((member) => (
            ...
            >
              {/* Image and LinkedIn Badge (Remains the same) */}
              ...
              {/* --- NEW NAME/TITLE CARD --- */}
              <div 
                className="text-gray-900 bg-white p-4 rounded-xl shadow-md w-full max-w-xs transition duration-300 hover:shadow-lg"
              >
