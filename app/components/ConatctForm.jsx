...
const LOGO_DATA = [
  { id: 1, name: "Partner Alpha", url: "/images/client-logo-2.png" },
  { id: 2, name: "Partner Beta", url: "/images/client-logo-1.png" },
  { id: 3, name: "Partner Gamma", url: "/images/client-logo-3.png" },
  { id: 4, name: "Partner Delta", url: "/images/client-logo-4.png" },
  { id: 5, name: "Partner Epsilon", url: "/images/client-logo-5.png" },
  { id: 6, name: "Partner Zeta", url: "/images/client-logo-6.png" },
];
  ...
  <div className="flex flex-col space-y-1">
    ...
    {isTextArea ? (
      <textarea
        ...
        rows="3"
        className="w-full px-4 py-2 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-400 transition duration-200 resize-none shadow-sm"
        required
        value={value}
        onChange={onChange}
      ></textarea>
      ...
      <input
        ...
        type={type}
        placeholder={placeholder}
        className="w-full px-4 py-2 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-400 transition duration-200 shadow-sm"
        required
        value={value}
        onChange={onChange}
      />
...
const LogoScroller = () => {
  ...
  <div className="overflow-hidden relative h-24 w-full rounded-xl border border-gray-200 bg-white shadow-inner flex items-center">
    <style>{`
    ...
    <div className="font-sans bg-white">
      <div className="p-4 sm:p-8 lg:p-12 bg-indigo-50"> 
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-stretch">
          ...
          {/* --- LEFT SIDE: FIXED VERTICAL ALIGNMENT --- */}
          {/* Added 'flex flex-col justify-center h-full' to center content vertically */}
          <motion.div
            initial="hidden"
            whileInView="visible"
          ...
          >
            <div>
              ...
              <motion.p
                ...
                initial="hidden"
                animate={controls}
                className="text-xl text-gray-700 text-left mt-4" 
              >
          ...
          <motion.div
            ...
            variants={variants}
          >
            <div className="p-4 sm:p-6 bg-white border border-gray-200 rounded-3xl shadow-xl h-full flex flex-col justify-center"> 
